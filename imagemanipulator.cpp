...
ImageManipulator::ImageManipulator()
{
 ...
 double ImageManipulator::angle(cv::Point pt1, cv::Point pt2, cv::Point pt0)
{
 ...
 */
bool ImageManipulator::checkcenter(const Rect * Rect1,const Rect * Rect2){
    return Rect1->height < Rect2->height;
}
void ImageManipulator::setLabel(cv::Mat& im, const std::string label, std::vector<cv::Point>& contour)
{
